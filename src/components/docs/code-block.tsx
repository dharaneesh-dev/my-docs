...
export function CodeBlock({ code, lang }: { code: string; lang?: string }) {
  ...
  return (
    <div className="my-4 overflow-hidden rounded-md border border-border bg-muted/40">
      <div className="flex items-center justify-between border-b border-border bg-background px-3 py-1.5 text-xs">
        <span className="font-mono uppercase tracking-wide text-muted-foreground">{lang || "text"}</span>
        <button
          onClick={copy}
      ...
      <div
        className="overflow-x-auto p-3 text-[13px] [&_pre]:!bg-transparent [&_pre]:!m-0 [&_code]:!font-mono"
