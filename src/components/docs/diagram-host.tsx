...
/** Shared React wrapper for every interactive diagram across every content chapter — mounts
 *  `render` into a plain div, and calls its cleanup function (if any) on unmount. */
